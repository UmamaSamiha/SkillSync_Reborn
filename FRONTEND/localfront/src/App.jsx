...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/teacher/topics"     element={<PrivateRoute teacherOnly><AdminTopicManager /></PrivateRoute>} />

      {/* Admin Routes */}
      <Route path="/admin"              element={<PrivateRoute adminOnly><AdminDashboard /></PrivateRoute>} />
      <Route path="/admin/edits"        element={<PrivateRoute adminOnly><AdminEditDashboard /></PrivateRoute>} />
      <Route path="/admin/topics"       element={<PrivateRoute adminOnly><AdminTopicManager /></PrivateRoute>} />
